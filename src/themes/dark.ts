...
export const darkTheme: DesignTokens = {
  ...
  sem_color_bkg_pri: '{pmt_color_gray_950}',
  sem_color_bkg_sec: '{pmt_color_gray_900}',
  sem_color_bkg_ter: '{pmt_color_gray_800}',
  sem_color_bkg_inv: '{pmt_color_white}',
  sem_color_bkg_overlay: 'rgba(0, 0, 0, 0.8)',
  sem_color_bkg_elevated: '{pmt_color_gray_900}',
  sem_color_bkg_sunken: '{pmt_color_black}',

  // --- Semantic Colors: Text ---
  sem_color_txt_pri: '{pmt_color_gray_50}',
  sem_color_txt_sec: '{pmt_color_gray_300}',
  sem_color_txt_ter: '{pmt_color_gray_500}',
  sem_color_txt_inv: '{pmt_color_gray_950}',
  sem_color_txt_dis: '{pmt_color_gray_600}',
  sem_color_txt_placeholder: '{pmt_color_gray_600}',
  sem_color_txt_lnk: '{pmt_color_blue_400}',
  sem_color_txt_lnk_hov: '{pmt_color_blue_300}',

  // --- Semantic Colors: Borders ---
  sem_color_bdr_default: '{pmt_color_gray_800}',
  sem_color_bdr_str: '{pmt_color_gray_700}',
  sem_color_bdr_sub: '{pmt_color_gray_900}',
  sem_color_bdr_inv: '{pmt_color_gray_200}',
  sem_color_bdr_dis: '{pmt_color_gray_800}',
  sem_color_bdr_foc: '{pmt_color_blue_500}',

  // --- Semantic Colors: States ---
  sem_color_state_err: '{pmt_color_red_500}',
  sem_color_state_err_bkg: 'rgba(239, 68, 68, 0.1)',
  sem_color_state_err_bdr: '{pmt_color_red_800}',
  sem_color_state_err_txt: '{pmt_color_red_400}',

  sem_color_state_suc: '{pmt_color_green_500}',
  sem_color_state_suc_bkg: 'rgba(34, 197, 94, 0.1)',
  sem_color_state_suc_bdr: '{pmt_color_green_800}',
  sem_color_state_suc_txt: '{pmt_color_green_400}',

  sem_color_state_wrn: '{pmt_color_yellow_500}',
  sem_color_state_wrn_bkg: 'rgba(234, 179, 8, 0.1)',
  sem_color_state_wrn_bdr: '{pmt_color_yellow_800}',
  sem_color_state_wrn_txt: '{pmt_color_yellow_400}',

  sem_color_state_inf: '{pmt_color_blue_500}',
  sem_color_state_inf_bkg: 'rgba(59, 130, 246, 0.1)',
  sem_color_state_inf_bdr: '{pmt_color_blue_800}',
  sem_color_state_inf_txt: '{pmt_color_blue_400}',

  // --- Semantic Colors: Interactive ---
  sem_color_interactive_pri: '{pmt_color_blue_600}',
  sem_color_interactive_pri_hov: '{pmt_color_blue_500}',
  sem_color_interactive_pri_act: '{pmt_color_blue_700}',
  sem_color_interactive_pri_dis: '{pmt_color_gray_800}',

  sem_color_interactive_sec: '{pmt_color_gray_800}',
  sem_color_interactive_sec_hov: '{pmt_color_gray_700}',
  sem_color_interactive_sec_act: '{pmt_color_gray_900}',

  sem_color_interactive_accent: '{pmt_color_purple_600}',
  sem_color_interactive_accent_hov: '{pmt_color_purple_500}',
  sem_color_interactive_accent_act: '{pmt_color_purple_700}',
  ...
  elm_lnk_color_vis: '{pmt_color_purple_400}',
  ...
  cmp_btn_dng_bkg_hov: '{pmt_color_red_400}',
  cmp_btn_dng_bkg_act: '{pmt_color_red_600}',
  ...
  cmp_mod_overlay_opac: '{pmt_opac_80}',
  ...
  // --- Tooltip Component ---
  cmp_tip_bkg: '{pmt_color_gray_800}',
  cmp_tip_txt_color: '{pmt_color_gray_50}',
  ...
  ftr_checkout_cta_bkg_hov: '{pmt_color_green_500}',
  ftr_checkout_cta_txt_color: '{pmt_color_white}',
  ftr_checkout_prg_bar_color: '{pmt_color_green_500}',
  ftr_checkout_trust_bdg_bkg: '{pmt_color_green_950}',
  ...
  ftr_dashboard_chart_sec_color: '{pmt_color_purple_500}',
  ftr_dashboard_stat_highlight_color: '{pmt_color_green_500}',

  // --- Settings Feature ---
  ftr_settings_section_bkg: '{cmp_cdl_bkg}',
  ftr_settings_section_bdr_color: '{cmp_cdl_bdr_color}',
  ftr_settings_danger_zone_bkg: 'rgba(239, 68, 68, 0.05)',
  ftr_settings_danger_zone_bdr_color: '{pmt_color_red_800}',
  ...
  // --- Onboarding Feature ---
  ftr_onboarding_prg_color: '{pmt_color_blue_500}',
  ftr_onboarding_step_act_color: '{pmt_color_blue_500}',
  ftr_onboarding_step_completed_color: '{pmt_color_green_500}',
  ftr_onboarding_highlight_bkg: 'rgba(59, 130, 246, 0.1)',

  // --- Profile Feature ---
  ftr_profile_header_bkg: '{sem_color_bkg_ter}',
  ftr_profile_avt_bdr_color: '{sem_color_bdr_default}',
  ftr_profile_avt_bdr_wdt: '{pmt_bdr_wdt_4}',
  ftr_profile_bdg_verified_color: '{pmt_color_blue_500}',
  ...
  ftr_messaging_inp_bkg: '{sem_color_bkg_ter}',
  ftr_messaging_timestamp_color: '{sem_color_txt_ter}',

  // --- Search Feature ---
  ftr_search_overlay_bkg: '{sem_color_bkg_overlay}',
  ftr_search_inp_bkg: '{sem_color_bkg_elevated}',
  ftr_search_result_bkg_hov: '{sem_color_bkg_ter}',
  ftr_search_highlight_color: '{pmt_color_yellow_500}',
