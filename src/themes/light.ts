...
export const lightTheme: DesignTokens = {
  ...
  sem_color_bkg_sec: '#fafafa',
  sem_color_bkg_ter: '#f5f5f5',
  sem_color_bkg_inv: '#0a0a0a',
  sem_color_bkg_overlay: 'rgba(0, 0, 0, 0.5)',
  sem_color_bkg_elevated: '#ffffff',
  sem_color_bkg_sunken: '#e5e5e5',

  // --- Semantic Colors: Text ---
  sem_color_txt_pri: '#171717',
  sem_color_txt_sec: '#525252',
  sem_color_txt_ter: '#737373',
  sem_color_txt_inv: '#ffffff',
  sem_color_txt_dis: '#a3a3a3',
  sem_color_txt_placeholder: '#a3a3a3',
  sem_color_txt_lnk: '#2563eb',
  sem_color_txt_lnk_hov: '#1d4ed8',

  // --- Semantic Colors: Borders ---
  sem_color_bdr_default: '#e5e5e5',
  sem_color_bdr_str: '#d4d4d4',
  sem_color_bdr_sub: '#f5f5f5',
  sem_color_bdr_inv: '#262626',
  sem_color_bdr_dis: '#e5e5e5',
  sem_color_bdr_foc: '#3b82f6',

  // --- Semantic Colors: States ---
  sem_color_state_err: '#dc2626',
  sem_color_state_err_bkg: '#fef2f2',
  sem_color_state_err_bdr: '#fecaca',
  sem_color_state_err_txt: '#b91c1c',

  sem_color_state_suc: '#16a34a',
  sem_color_state_suc_bkg: '#f0fdf4',
  sem_color_state_suc_bdr: '#bbf7d0',
  sem_color_state_suc_txt: '#15803d',

  sem_color_state_wrn: '#ca8a04',
  sem_color_state_wrn_bkg: '#fefce8',
  sem_color_state_wrn_bdr: '#fef08a',
  sem_color_state_wrn_txt: '#854d0e',

  sem_color_state_inf: '#2563eb',
  sem_color_state_inf_bkg: '#eff6ff',
  sem_color_state_inf_bdr: '#bfdbfe',
  sem_color_state_inf_txt: '#1d4ed8',

  // --- Semantic Colors: Interactive ---
  sem_color_interactive_pri: '#2563eb',
  sem_color_interactive_pri_hov: '#1d4ed8',
  sem_color_interactive_pri_act: '#1e40af',
  sem_color_interactive_pri_dis: '#e5e5e5',

  sem_color_interactive_sec: '#f5f5f5',
  sem_color_interactive_sec_hov: '#e5e5e5',
  sem_color_interactive_sec_act: '#d4d4d4',

  sem_color_interactive_accent: '#9333ea',
  sem_color_interactive_accent_hov: '#7e22ce',
  sem_color_interactive_accent_act: '#6b21a8',
  ...
  cmp_btn_dng_bkg_hov: '#b91c1c',
  cmp_btn_dng_bkg_act: '#991b1b',
