var E=new WeakMap,X=new MutationObserver((e)=>{for(let o of e)if(o.type==="childList")o.removedNodes.forEach((n)=>{if(n instanceof HTMLElement&&E.has(n))E.get(n).forEach((i)=>i()),E.delete(n)})});X.observe(document.body,{childList:!0,subtree:!0});function J(e){return(...o)=>{let n=o[0],s=e(...o),i=E.get(n)||[];return i.push(s),E.set(n,i),()=>{let r=E.get(n);if(r){let u=r.indexOf(s);if(u!==-1)r.splice(u,1);if(r.length===0)E.delete(n)}s()}}}function Z(e,o){return(...n)=>{let i=document.createElementNS("http://www.w3.org/1999/xhtml",e);return tt(i,n,o)}}function tt(e,o=[],n={}){o.forEach(([i,...r])=>J(n[i])(e,...r));function s(...i){return i.forEach((r)=>{if(r)e.append(r)}),e}return s}function O(e){return new Proxy({},{get:(o,n)=>Z(n,e)})}function et(e,o){if(!o)return e;let n=o.storage.getItem(o.key),s=JSON.parse(n),i=s!==null&&s!==void 0;if((o.overwrite??!0)&&i)return s;if(!(o.overwrite??!0)&&i){if(Array.isArray(e)&&Array.isArray(s))return[...e,...s];else if(typeof e==="object"&&typeof s==="object")return{...e,...s}}return e}function k(e,o){let n=et(e,o),s=new Set,i=()=>n,r=(a)=>{if(n=a,s.forEach((A)=>A(a)),o)o.storage.setItem(o.key,JSON.stringify(a))},u=(a)=>()=>r(a),y=(a)=>r(a(n)),b=(a)=>()=>r(a(i())),v=(a)=>{return s.add(a),()=>w(a)},f=(a,A=!0)=>{let I=JSON.stringify(n);if(a instanceof RegExp){let h=a.test(I);return A?h:!h}else if(typeof a==="function"&&a instanceof Function){let h=a(n);return A?h:!h}else{let h=JSON.stringify(a),N=I===h;return A?N:!N}},H=(a,A=!0)=>()=>{let I=JSON.stringify(n);if(a instanceof RegExp){let h=a.test(I);return A?h:!h}else if(typeof a==="function"&&a instanceof Function){let h=a(n);return A?h:!h}else{let h=JSON.stringify(a),N=I===h;return A?N:!N}},w=(a)=>{s.delete(a)};return{reduce:y,set:r,sub:v,test:f,unsub:w,val:i,$reduce:b,$set:u,$test:H,_subs:s}}function P(e,o=[],n={}){o.forEach(([i,...r])=>n[i](e,...r));function s(...i){return i.forEach((r)=>e.append(r)),e}return s}function W(e){return new Proxy({},{get:(o,n)=>{if(n==="el")return(s)=>(...i)=>P(s,i,e);return(...s)=>{let r=document.createElementNS("http://www.w3.org/2000/svg",n);return P(r,s,e)}}})}var $=(e)=>{let{type:o="all",minWidth:n=0,maxWidth:s=1/0}=e,i=k(!1),r=()=>{let u=window.innerWidth,y=u>=n&&u<=s,b=o==="all"||window.matchMedia(o).matches;i.set(y&&b)};return r(),window.addEventListener("resize",r),i};var R=(...e)=>{let[o,n,s,i=!0,r=[]]=e,u=()=>{let v=typeof s==="function"?s():s;if((Array.isArray(i)?i:[i]).every((w)=>{return typeof w==="function"?w():w}))if(v===void 0)o.removeAttribute(n);else o.setAttribute(n,String(v));else o.removeAttribute(n)};u();let b=(Array.isArray(r)?r:[r]).map((v)=>v.sub(u));return()=>b.forEach((v)=>v())};var z=(...e)=>{let[o,n,s,i=!0,r=[]]=e,u=!1,y=()=>{if((Array.isArray(i)?i:[i]).every((w)=>{return typeof w==="function"?w():w})&&!u)o.addEventListener(n,s),u=!0;else o.removeEventListener(n,s),u=!1};y();let v=(Array.isArray(r)?r.flat():[r]).map((f)=>f.sub(y));return()=>{o.removeEventListener(n,s),v.forEach((f)=>f())}};var F=(...e)=>{let[o,n,s=!0,...i]=e,r=()=>{let y=n();if((Array.isArray(s)?s:[s]).every((f)=>{return typeof f==="function"?f():f})){if(o.innerHTML="",y!==void 0)if(Array.isArray(y))y.filter((f)=>f).forEach((f)=>{if(f instanceof HTMLElement||f instanceof SVGElement)o.appendChild(f);else o.appendChild(document.createTextNode(String(f)))});else if(y instanceof HTMLElement||y instanceof SVGElement)o.appendChild(y);else o.innerHTML=String(y)}};r();let u=i.map((y)=>y.sub(r));return()=>u.forEach((y)=>y())};var G=(...e)=>{let[o,n,s,i=!0,...r]=e,u=()=>{let b=typeof s==="function"?s():s;if((Array.isArray(i)?i:[i]).every((H)=>{return typeof H==="function"?H():H}))n.startsWith("--")?o.style.setProperty(n,b):o.style[n]=b};u();let y=r.map((b)=>b.sub(u));return()=>y.forEach((b)=>b())};var ot=(e)=>{e.style.display="block",e.style.whiteSpace="pre",e.style.fontFamily="monospace",e.style.color="white",e.style.backgroundColor="black",e.style.padding="30px",e.style.borderRadius="5px",e.style.overflowX="auto",e.style.maxWidth="100%",e.style.width="100%",e.style.minWidth="0",e.style.boxSizing="border-box",e.style.wordBreak="normal";let o=new MutationObserver((n)=>{n.forEach((s)=>{if(s.type==="childList"){if(s.addedNodes.length>0){o.disconnect();let i=Prism.highlight(e.innerText,Prism.languages.typescript);e.innerHTML=i}}})});return o.observe(e,{childList:!0}),e},c=k("introduction",{key:"menuState",storage:localStorage}),M=k(!1),x=$({type:"screen",minWidth:0,maxWidth:959}),p=$({type:"screen",minWidth:960,maxWidth:1/0}),t=O({attr:R,event:z,prism:ot,style:G,html:F}),At=W({attr:R,style:G,event:z});var d=(e,o,...n)=>t.div(["attr","data-part","Box"],["style","flexDirection",e],["style","alignItems","center"],["style","boxSizing","border-box"],["style","display","grid"],["style","fontFamily","Space Grotesk"],["style","gap",`${o}px`],["style","minWidth",0],["style","overflow","hidden"],["style","width","100%"],["style","alignItems","stretch"])(...n);var T=({next:e,prev:o})=>t.div(["style","display","flex"],["style","flexDirection","row"],["style","justifyContent","space-evenly"],["style","alignItems","center"],["style","width","100%"],["style","boxSizing","border-box"],["style","padding","20px"],["style","fontFamily","monospace"],["style","fontSize","14px"],["style","backgroundColor","black"],["style","color","white"],["style","borderRadius","5px"])(o&&t.div(["style","cursor","pointer"],["event","click",()=>c.set(o.menuState)])(`← ${o.title}`),e&&t.div(["style","cursor","pointer"],["event","click",()=>c.set(e.menuState)])(`${e.title} →`));var g=(...e)=>t.div(["attr","data-part","Page"],["style","flexDirection","column"],["style","alignItems","center"],["style","boxSizing","border-box"],["style","display","flex"],["style","fontFamily","Space Grotesk"],["style","justifyContent","center"],["style","gap","30px"],["style","maxWidth","1000px"],["style","minWidth",0])(...e);g.Header=(e,o)=>t.div(["style","display","flex"],["style","flexDirection","column"],["style","alignItems","center"],["style","justifyContent","center"],["style","textAlign","center"],["style","gap","10px"])(t.h1(["style","fontSize","48px"],["style","margin","0"],["style","padding","0"],["style","fontWeight","bold"])(e),o?t.h2(["style","fontSize","18px"],["style","margin","0"],["style","padding","0"],["style","fontWeight","normal"],["style","opacity",0.7])(o):null);var l=({content:e,title:o,subtitle:n})=>t.div(["attr","data-part","Section"],["style","flexDirection","column"],["style","alignItems","center"],["style","boxSizing","border-box"],["style","display","flex"],["style","fontFamily","Space Grotesk"],["style","minWidth",0])(t.h2(["style","fontSize","32px"],["style","textAlign","center"],["style","padding",0],["style","margin",0])(o),n&&t.div(["style","fontSize","16px"],["style","opacity",0.5],["style","textAlign","center"],["style","padding","10px 20px 20px 20px"])(n),t.div(["attr","data-part","SectionContent"],["style","flexDirection","column"],["style","alignItems","center"],["style","boxSizing","border-box"],["style","display","flex"],["style","fontFamily","Space Grotesk"],["style","justifyContent","center"],["style","width","100%"],["style","display","flex"],["style","minWidth",0])(e));var S=(e)=>t.code(["style","backgroundColor","rgba(0,0,0,0.1)"],["style","borderRadius","3px"],["style","fontFamily","monospace"],["style","fontSize","14px"],["style","padding","2px 5px"],["style","margin","0 2px"])(e),C=(...e)=>t.small(["style","display","block"],["style","fontSize","13px"],["style","opacity",0.5],["style","textAlign","center"],["style","padding","20px"],["style","marginBottom","20px"],["style","backgroundColor","rgba(0,0,0,0.1)"])(...e);var j=()=>g(g.Header("Docs","OEM only has two functions — HTML and State. Here's how they work."),l({title:"HTML",subtitle:"OEM's HTML template engine is a lightweight and efficient way to create and manage HTML elements in your application.",content:d("column",10,t.pre(["prism"])(`import { HTML } from 'oem';
...
tmpl.div()('Hello, OEM!');
// <div>Hello, OEM!</div>
`))}),C("There's also an ",S("SVG")," version of the HTML function for creating SVG elements."),l({title:"State",subtitle:"OEM's built-in state management is simple yet powerful. Each state object is a micro event bus that can be used anywhere in your application.",content:d("column",10,t.pre(["prism"])(`import { State } from 'oem'; 
...
`),C("Notice how with this pattern you can apply the same style property multiple times based on different conditions? You can't do that with JSX or CSS without ugly if statements or complex class management. This keeps your code declarative and easy to reason about."))}),l({title:"Thank You",subtitle:"We appreciate your interest in OEM. We hope you find this project useful. Feel free to contribute or provide feedback!",content:T({next:{title:"State",menuState:"state"},prev:{title:"Introduction",menuState:"introduction"}})}));var m={Grid:(...e)=>t.div(["style","borderRadius","5px"],["style","boxSizing","border-box"],["style","display","grid"],["style","gridTemplateColumns","1fr 1fr"],["style","width","100%"])(...e),Header:(e)=>t.div(["style","backgroundColor","rgba(0,0,0,0.1)"],["style","padding","10px"])(e),Cell:(e)=>t.div(["style","padding","10px"],["style","borderBottom","1px solid rgba(0,0,0,0.1)"],["style","fontSize","13px"],["style","fontSize","16px",p.val,p])(e)};var V=()=>g(g.Header("State","Managing dynamic data with OEM State"),l({title:"The State Object",subtitle:"Each state object in OEM is a micro event bus that can be used anywhere in your application. Although OEM is state management agnostic, it's built-in state management works great for most use cases.",content:d("column",10,t.div(["style","textAlign","center"])("Import the State function to create a state object"),t.pre(["prism"])(`import { State } from 'oem';
...
)('...');`),C("Note: you could have applied the style textAlign trait multiple times to the same element with different values, and it would apply them in order. However, that would only make sense if we had a way to add a condition. That's exactly what we cover in the Patterns section. First, let's see how State works."))}),l({title:"Ready-Made Traits",subtitle:"Here's a set of powerful pre-built traits that include configurations for responding to events, media queries and state objects with the Locality of Behavior pattern included which covers 95% of use cases out of the box.",content:m.Grid(m.Header("Trait"),m.Header("Description"),m.Cell(t.a(["attr","href","https://raw.githubusercontent.com/linttrapmedia/oem/refs/heads/main/src/lib/traits/Style.ts"],["attr","target","_blank"])("useAttributeTrait")),m.Cell("Apply attributes"),m.Cell(t.a(["attr","href","https://raw.githubusercontent.com/linttrapmedia/oem/refs/heads/main/src/lib/traits/ClassName.ts"],["attr","target","_blank"])("useClassNameTrait")),m.Cell("Apply class names"),m.Cell(t.a(["attr","href","https://raw.githubusercontent.com/linttrapmedia/oem/refs/heads/main/src/lib/traits/Event.ts"],["attr","target","_blank"])("useEventTrait")),m.Cell("Attach event listener"),m.Cell(t.a(["attr","href","https://raw.githubusercontent.com/linttrapmedia/oem/refs/heads/main/src/lib/traits/InnerHTML.ts"],["attr","target","_blank"])("useInnerHTMLTrait")),m.Cell("Attach event listener"),m.Cell(t.a(["attr","href","https://raw.githubusercontent.com/linttrapmedia/oem/refs/heads/main/src/lib/traits/TextContent.ts"],["attr","target","_blank"])("useTextContentTrait")),m.Cell("Apply inner text"),m.Cell(t.a(["attr","href","https://raw.githubusercontent.com/linttrapmedia/oem/refs/heads/main/src/lib/traits/Style.ts"],["attr","target","_blank"])("useStyleTrait")),m.Cell("Apply styles"))}),l({title:"State",subtitle:'OK, we can generate html, and now have a way to manipulate it with traits. But how do we make it dynamic? What if we could reapply traits when something changes? Enter "State".',content:T({next:{title:"State",menuState:"state"},prev:{title:"Templates",menuState:"templates"}})}));var U={name:"@linttrap/oem",author:"@linttrapmedia",title:"oem",version:"1.0.0",description:"A novel UI library for writing reactive html with vanilla javascript",type:"module",exports:{".":"./src/index.ts"},main:"./src/index.ts",module:"./src/index.ts",repository:{type:"git",url:"git+https://github.com/linttrapmedia/oem.git"},license:"MIT",bugs:{url:"https://github.com/linttrapmedia/oem/issues"},homepage:"https://oem.js.org",devDependencies:{"@types/bun":"latest",prettier:"2.7.1"},dependencies:{},private:!1,peerDependencies:{typescript:"^5"}};var L=(e,o)=>{let n=k(!1);return t.div(["style","padding","10px 20px"],["style","cursor","pointer"],["style","transition","background-color 0.3s"],["style","textTransform","uppercase"],["style","color","yellow",!0,n,c],["style","color","white",()=>n.test(!1)&&c.test(o,!1),n,c],["event","click",c.$set(o)],["event","mouseover",n.$set(!0)],["event","mouseout",n.$set(!1)])(e)},Y=()=>t.div(["style","backgroundColor","black"],["style","color","white"],["style","padding","10px"],["style","fontWeight","bold"],["style","fontFamily","monospace"],["style","display","flex"],["style","flexDirection","column"],["style","alignItems","center"],["style","justifyContent","center"],["style","textAlign","center"],["html",()=>[t.div(["style","position","absolute"],["style","top","10px"],["style","right","10px"],["style","cursor","pointer"],["style","fontSize","21px"],["style","textTransform","uppercase"],["style","padding","5px"],["style","opacity","0.5"],["style","display","flex",x.val,x],["style","display","none",p.val,p],["event","click",M.$reduce((e)=>!e)],["html",()=>"-",M.$test(!0),M],["html",()=>"=",M.$test(!1),M])(),t.div(["style","display","flex"],["style","flexDirection","column"],["style","alignItems","center"],["style","justifyContent","center"],["style","position","relative"])(t.div(["style","display","flex"],["style","letterSpacing","2px"],["style","fontSize","40px"],["style","textAlign","left"],["style","lineHeight",0.75],["style","color","white"],["style","fontFamily","Splash"],["style","gap","5px"],["style","fontWeight","normal"],["style","cursor","pointer"],["event","click",c.$set("introduction")])("oem",t.span(["style","fontSize","10px"],["style","fontWeight","bold"],["style","fontFamily","monospace"],["style","letterSpacing","0"],["style","color","yellow"])(U.version))),t.div(["style","display","flex"],["style","flexDirection","column"],["style","justifyContent","center"],["style","display","none",()=>x.val()&&!M.val(),M,x],["style","display","flex",()=>p.val()||M.val(),M,p],["style","paddingTop","20px"])(L("Intro","introduction"),L("Docs","docs"),L("Templates","templates"),L("Traits","traits"),L("State","state"),L("Patterns","patterns"),t.a(["style","marginTop","20px"],["style","color","white"],["style","padding","10px"],["style","textDecoration","none"],["style","border","1px solid rgba(255,255,255,0.2)"],["attr","href","https://github.com/linttrapmedia/oem"],["attr","target","_blank"])("GITHUB"))]])();function st(){return t.div(["attr","data-part","App"],["style","display","grid"],["style","gridTemplateRows","max-content 1fr",x.val,x],["style","gridTemplateColumns","1fr",x.val,x],["style","gridTemplateRows","auto",p.val,p],["style","gridTemplateColumns","max-content 1fr",p.val,p],["style","height","100vh",p.val,p],["style","height","auto",x.val,x],["style","justifyContent","start"],["style","width","100vw",p.val,p],["style","width","auto",x.val,x],["style","overflow","hidden"],["style","minWidth",0])(t.div(["style","backgroundColor","black"],["style","padding","10px"])(Y()),t.div(["attr","data-part","AppContent"],["style","display","flex"],["style","flexDirection","column"],["style","gap","50px"],["style","boxSizing","border-box"],["style","padding","20px 20px 100px"],["style","height","100%"],["style","overflowY","auto"],["style","overflowX","hidden"],["style","maxWidth","100%"],["style","minWidth",0],["html",B,c.$test("introduction"),c],["html",j,c.$test("docs"),c],["html",_,c.$test("templates"),c],["html",K,c.$test("traits"),c],["html",V,c.$test("state"),c],["html",q,c.$test("patterns"),c])())}document.addEventListener("DOMContentLoaded",()=>{let e=document.getElementById("root");if(!e)return null;e.appendChild(st())});function Q(){document.querySelector("[data-part='AppContent']")?.scrollTo({top:0})}c.sub(Q);document.addEventListener("keydown",(e)=>{let o=e.key,n=c.val();if(o!=="ArrowRight"&&o!=="ArrowLeft")return;let i={introduction:o==="ArrowRight"?"docs":"patterns",docs:o==="ArrowRight"?"templates":"introduction",templates:o==="ArrowRight"?"traits":"docs",traits:o==="ArrowRight"?"state":"templates",state:o==="ArrowRight"?"patterns":"traits",patterns:o==="ArrowRight"?"introduction":"state"}[n];if(!i)return;c.set(i),Q()});

//# debugId=885F81E972668C3F64756E2164756E21
