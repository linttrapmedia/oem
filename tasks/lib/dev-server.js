...
const startDevServer = () => {
  http
    .createServer((req, res) => {
      ...
      const filepath = path.extname(sanitizePath) === '' ? sanitizePath + 'index.html' : sanitizePath;
      let pathname = path.join(__dirname + '/../../public', filepath);
      ...
      if (!fs.existsSync(pathname)) {
        ...
        console.log('served:', parsedUrl.pathname);
  ...
  console.log(`🕹 Client: http://localhost:${config.devPort}`);
};
